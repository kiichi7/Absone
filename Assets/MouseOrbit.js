...
private var maxDistance = 1000.0; 
private var maxSpeed = 0.3;
private var rollSpeed = 0.3;
...
function Update () {
	...
	if (Input.GetMouseButtonDown(0)) {
		ifBrain = !ifBrain;
		if (ifBrain) target = brain;
		else target = brainWave;
	}
	//if (Input.GetMouseButtonDown(1)) target = brainWave;
